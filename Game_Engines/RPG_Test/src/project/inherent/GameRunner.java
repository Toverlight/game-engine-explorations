...
import project.inherent.old.MainSceneMap;
 ...
 * <p>
 *     从该入口类启动。<br>
 *     <b>注意</b>：如用测试类渲染(get gc之前)，请先设置该类的GraphicsContext gc，以避免渲染时空指针错误。
 * </p>
 */
public final class GameRunner extends Application {
    private static long lastTime = 0;
    private static double deltaTime;
    private static GameScene mainGameScene;
    ...
    public static void initLogger() {
        if (!isLoggerInitialized) {
            try {
                ...
                System.out.println("Failed to read 'logging.properties'：\n" + e);
            }
    ...
    public void start(Stage primaryStage) {
        ...
        Timeline timeline = new Timeline(
                new KeyFrame(Duration.millis(1000), event -> {
                    ...
                    logger.fine("currentFPS: " + currentFPS);
                    if (i.get() >= 5) {
    ...
    public static void main(String[] args) {
        ...
        LogUtils.info("GameRunner launched.");
        launch(args);// 启动游戏
    }
